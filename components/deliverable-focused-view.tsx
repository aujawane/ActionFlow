      ...
      <Modal open={dialog === "accept"} title="Accept this deliverable?" onClose={closeDialog}>
        ...
        <p className="mt-2 text-sm leading-6 text-slate-600">
          {taskState.status === "completed" ? (
            <>
              <span className="font-semibold text-slate-900">&ldquo;{task.task}&rdquo;</span> is
              already completed by another accepted deliverable. Accepting this one keeps it
              completed.
            </>
          ) : (
            <>
